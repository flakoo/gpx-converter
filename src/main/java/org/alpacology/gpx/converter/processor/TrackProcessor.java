...
public class TrackProcessor implements Processor {
	...
	public void process(XMLStreamReader inputStream, XMLStreamWriter outputStream) throws XMLStreamException, JAXBException {
		try {
			while (true) {
				processNextTrack(inputStream, outputStream);
			}
	...
	private void processNextTrack(XMLStreamReader inputStream, XMLStreamWriter outputStream) throws XMLStreamException, JAXBException {
		...
		segmentProcessor.process(inputStream, outputStream);
